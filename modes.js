...
const ROLE_KEYWORDS={
 '封印師':['劍意末路','探索旅','獸耳同盟'],'記錄者':['繼承者'],'結界師':['神子創臨','獸耳同盟'],'靈魂術士':['學院都市','探索旅'],'冒險家':['探索旅'],'魔劍士':['劍意末路','魔裝少女'],'魔槍':['女武神計畫','魔裝少女'],'魔弓':['禦神之亂','弓神候補','魔裝少女'],'瘟疫法師':['黑衣聖教','神霾之下','幕後策首'],'異教徒':['歧路姊妹'],'陰陽師':['巫女暴走','獸耳同盟'],
 '暗殺者':['特經社','獵人'],'風之劍聖':['劍意末路','八想流','繼承者'],'格鬥家':['圓桌統合','繼承者'],'劍帝':['圓桌統合','繼承者'],'精靈射手':['禦神之亂','精靈同盟'],'獵巫人':['紅蓮叛亂','獵人'],'女僕長':['神子創臨','特經社','獵物'],'神箭手':['禦神之亂','弓神候補'],'獸靈武士':['巫女暴走','巫女機關','獸耳同盟'],
...
function renderReFinal(){
 ...
 const last=state.history.at(-1),lastMine=last?.[last.playerTeam]||[],championRole=state.reFavoriteUsed?state.favorite:byId(lastMine[Math.floor(Math.random()*lastMine.length)])?.name,usedBard=state.history.some(match=>(match[match.playerTeam]||[]).some(id=>byId(id)?.name==='吟游詩人')),wheelchair=rank>3&&usedBard;
